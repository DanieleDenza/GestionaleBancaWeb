package it.daniele.banca.controller;
...
import it.daniele.banca.service.ContoCorrenteService;
import it.daniele.banca.service.UtenteBancarioService;
...
public class UtenteBancarioController {
	...
	public String listaConti(@PathVariable ( value = "id") long id , Model model) {
		...
		model.addAttribute("utente" ,contoService.findAllContiByUtentebancario(utente));
